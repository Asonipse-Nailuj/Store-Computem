...
<head>
  ...
  <title>Store Computem | Crear Usuario</title>
                  ...
                  <form class="" action="" method="post" novalidate>
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" data-validate-length-range="6" data-validate-words="1" name="usuario" required="required" />
                      </div>
                    </div>
                    ...
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        <div class="radio">
                          <label>
                            <input type="radio" checked value="admin" id="optionsRadios1" name="tipo"> Administrador
                          </label>
                        </div>
                        <div class="radio">
                          <label>
                            <input type="radio" value="vendedor" id="optionsRadios2" name="tipo"> Vendedor
                          </label>
                        </div>
                      </div>
                    </div>
