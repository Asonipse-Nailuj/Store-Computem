...
<head>
  ...
  <title>Store Computem | Crear Cliente</title>
          ...
          <div class="row">
            ...
            if (!empty($registrado)) {
              echo '<div class="alert alert-success alert-dismissible " role="alert">
                      ...
                      <strong>TODO CORRECTO!</strong> El cliente ha sido registrado en el sistema.
                    </div>';
            }
            ?>
                ...
                <div class="x_content">
                  <form class="" action="" method="post" novalidate>
                    ...
                    <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">N° Documento<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" type="number" class='number' name="documento" required='required'></div>
                    </div>

                    <div class="field item form-group">
                      <label class="col-form-label col-md-3 col-sm-3  label-align">Nombres<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" data-validate-length-range="3" data-validate-words="1" name="nombre" required="required" />
                      </div>
                    </div>
                    ...
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="apellido" required="required" />
                      </div>
                    </div>
                    ...
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" data-validate-length-range="5,15" data-validate-words="2" name="direccion" required="required" />
                      </div>
                    </div>
                    ...
                    <div class="field item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                        <input class="form-control" type="tel" class='tel' name="telefono" required='required' data-validate-length-range="6,20" /></div>
                    </div>
